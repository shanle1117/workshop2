...
class QueryProcessor:
    ...
    def __init__(self):
        ...
        self.intent_patterns = {
            'curriculum': ['course', 'subject', 'module', 'kokurikulum', 'curriculum', 'class', 'lecture'],
            'registration': ['register', 'enroll', 'enrollment', 'admission', 'apply', 'sign up', 'deadline'],
            'schedule': ['schedule', 'timetable', 'calendar', 'when', 'time', 'date', 'semester'],
            'staff': ['contact', 'email', 'phone', 'number', 'professor', 'lecturer', 'staff', 'faculty'],
            'facilities': ['lab', 'laboratory', 'facility', 'equipment', 'room', 'building', 'campus'],
            'programs': ['program', 'degree', 'bachelor', 'master', 'requirement', 'eligibility', 'duration'],
            # NEW INTENT: Match fees (ID 5)
            'fees': ['tuition', 'fees', 'cost', 'payment', 'price', 'money'],
    
            # NEW INTENT: Match financial_aid (ID 6)
            'financial_aid': ['scholarship', 'financial aid', 'funding', 'loan', 'bursary', 'aid'],
            
            # NEW INTENT: Match academic_policy (ID 12, 13, 14, 18)
            'academic_policy': ['gpa', 'grade', 'graduation', 'policy', 'cgpa', 'credits', 'attendance', 'absence'],
            
            # NEW INTENT: Match technical (ID 9, 20, 26)
            'technical': ['password', 'login', 'portal', 'reset', 'IT', 'help desk', 'computer'],
            
            # NEW INTENT: Match career (ID 11, 27)
            'career': ['internship', 'job', 'work', 'career', 'placement', 'resume', 'interview', 'employment'],
            
            # NEW INTENT: Match advising (ID 17)
            'advising': ['advisor', 'advising', 'academic help', 'counseling', 'guidance'],
            
            # NEW INTENT: Match housing (ID 15)
            'housing': ['accommodation', 'dorm', 'housing', 'residence', 'hostel', 'room'],
            
            # NEW INTENT: Match student_life (ID 16)
            'student_life': ['club', 'society', 'organization', 'activities', 'extracurricular'],
            
            # NEW INTENT: Match wellness (ID 29)
            'wellness': ['counseling', 'mental health', 'therapy', 'stress', 'support'],
        }
